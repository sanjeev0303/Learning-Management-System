...
const GroupCreatePage = async ({ searchParams }: PageProps) => {
    ...
    <>
      <div className="px-7 flex flex-col">
        ...
        {affiliate.status === 200 && (
          <div className="w-full mt-5 flex justify-center items-center gap-x-2 italic text-themeTextWhite text-sm">
